                            ...
                            <div class="row product-items-active">
                                ...
                                <div class="col-md-4">
                                    <div class="single-product-items">
                                        ...
                                        <div class="product-item-content text-center mt-30">
                                            <h5 class="product-title"><a href="#">Modern Kitchen Table</a></h5>
                                            <ul class="rating">
                                                <li><i class="lni-star-filled"></i></li>
                                                <li><i class="lni-star-filled"></i></li>
                                                <li><i class="lni-star-filled"></i></li>
                                            ...
                                            <span class="regular-price">$1590.00</span>
                                            <span class="discount-price">$1469.00</span>
                                        </div>
                                    </div> <!-- single product items -->
                                </div>
                                <div class="col-md-4">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    ...
                    <div class="team-content mt-30">
                        <h4 class="title mb-10"><a href="#">Frederique CARRIER</a></h4>
                        <span>FOUNDER</span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    ...
                    <div class="team-content mt-30">
                        <h4 class="title mb-10"><a href="#">Patrick LAPORTE</a></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    ...
                    <div class="team-content mt-30">
                        <h4 class="title mb-10"><a href="#">Jean ROMANO</a></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    ...
                    <div class="team-content mt-30">
                        <h4 class="title mb-10"><a href="#">Yacine Madi</a></h4>
                        ...
                        <div class="meta d-flex justify-content-between align-items-center">
                            <div class="meta-admin d-flex align-items-center">
                                ...
                                <div class="admin-title">
                                    <h6 class="title"><a href="#">S. GAGNON</a></h6>
                                </div>
                            </div> <!-- meta admin -->
                            <div class="meta-icon">
                                <ul>
                    ...
                    <div class="blog-content">
                        ...
                        <div class="meta d-flex justify-content-between align-items-center">
                            <div class="meta-admin d-flex align-items-center">
                                ...
                                <div class="admin-title">
                                    <h6 class="title"><a href="#">Y. SIROIS</a></h6>
                                </div>
                            </div> <!-- meta admin -->
                            <div class="meta-icon">
                                <ul>
                    ...
                    <div class="blog-content">
                        ...
                        <div class="meta d-flex justify-content-between align-items-center">
                            <div class="meta-admin d-flex align-items-center">
                                ...
                                <div class="admin-title">
                                    <h6 class="title"><a href="#">J. TREMBLAY</a></h6>
                                </div>
                            </div> <!-- meta admin -->
                            <div class="meta-icon">
                                <ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="single-info mt-30">
                                    ...
                                    <div class="info-content">
                                        <p>5898 Rene Levesque O, Montreal, H4F 6T6,Quebec</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="single-footer-info mt-20">
                                    <span>Address :</span>
                                    <div class="footer-info-content">
                                        <p>5898 Rene Levesque O, Montreal, H4F 6T6</p>
                                    </div>
                                </div> <!-- single footer info -->
                            </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright text-center">
                        <p>Crafted by <a href="https://Ismail.com" rel="nofollow">Ismail</a></p>
                    </div> <!-- copyright -->
                </div>
            </div> <!-- row -->
